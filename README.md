...
To evaluate the performance of ACM in the scenario with lower labeled data (5%), we further analyzed the collaborative contributions of different components (**DSS**, **CS**, and **SCM**) in Fundus Dataset, and used the *Dice* as the evaluation metric. We will present more results in our subsequent journal papers.
